...
public class tumoralGrowth{
	...
	public static void caComputation(){
		//try{
			while(start){
				//barrera.await();
				for (int x=0; x<dim;++x) {
		...
		// mainGUI.lifeg.panelopt.btnStart.setText("Restart");
		// mainGUI.lifeg.panelopt.btnGrafica.setEnabled(true);
	}
        ...
        btnStart.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ...
                if(btnStart.getText().equals("Start")){
                	tumoralGrowth.start=true;
                    btnStart.setText("Stop");

                    hiloSim = new Thread(()->{tumoralGrowth.runSimulation( (Integer)SpinnerDim.getValue(),
